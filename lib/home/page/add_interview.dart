...
class AddInterviewPage extends StatefulWidget {
  const AddInterviewPage({super.key});
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                      labelText: "Enter Interview Title",
                ...
                TextFormField(
                  ...
                  keyboardType: TextInputType.name,
                  decoration: const InputDecoration(
                      labelText: "Enter Interview Description",
                      labelStyle: TextStyle(
                          fontSize: 12.0,
                          fontWeight: FontWeight.w600,
                          color: Colors.grey),
                ...
                ElevatedButton(
                  onPressed: ()async {
                   await FirebaseFirestore.instance.collection('interview').doc().set({
                  ...
                  child: const Text("Upload Interview"),
                )
              ],
            )),
          ),
